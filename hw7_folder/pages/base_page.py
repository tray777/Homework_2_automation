...
class Page:
    ...
    def wait_element_visible(self, *locator):
        self.wait.until(EC.visibility_of_element_located(locator), message=f"Element by {locator} is not visible")

    def wait_element_invisible(self, *locator):
        self.wait.until(EC.invisibility_of_element_located(locator), message=f"Element by {locator} should not be visible")
    ...
    def verify_partial_url(self, expected_partial_url):
        ...
        self.wait.until(EC.url_contains(expected_partial_url),message = f"Expected '{expected_partial_url}' not in '{actual_url}'")